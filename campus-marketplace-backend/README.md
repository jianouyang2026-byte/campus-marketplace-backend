...
You can also create a local `.env` file in the project folder. The Python scripts will read it automatically.
...
Do not upload the real `.env` file to GitHub. It is ignored by `.gitignore`.
